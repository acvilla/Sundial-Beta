...
void MICROSD_Init(void)
{
  ...
  MICROSD_USART->ROUTE = MICROSD_LOC;
  MICROSD_USART->ROUTE |= USART_ROUTE_TXPEN | USART_ROUTE_RXPEN | USART_ROUTE_CLKPEN | MICROSD_LOC;
  MICROSD_USART->ROUTE &=  ~USART_ROUTE_CSPEN; //Release the USART module's control of CS Pin
