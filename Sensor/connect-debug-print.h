...
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_USB_CDC)
#define emberAfPluginUsbCdcPrint(...) emberAfPrint(EMBER_AF_PRINT_PLUGIN_USB_CDC, __VA_ARGS__)
#define emberAfPluginUsbCdcPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PLUGIN_USB_CDC,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPluginUsbCdcFlush()
#define emberAfPluginUsbCdcDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PLUGIN_USB_CDC) ) { x; }
#define emberAfPluginUsbCdcPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PLUGIN_USB_CDC, (buffer), (len), (withSpace))
#define emberAfPluginUsbCdcPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PLUGIN_USB_CDC, (buffer))
#else
#define emberAfPluginUsbCdcPrint(...)
#define emberAfPluginUsbCdcPrintln(...)
#define emberAfPluginUsbCdcFlush()
#define emberAfPluginUsbCdcDebugExec(x)
#define emberAfPluginUsbCdcPrintBuffer(buffer, len, withSpace)
#define emberAfPluginUsbCdcPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_USB_CDC)


// Generated functions for use within plugin USB Common
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_USB_COMMON)
#define emberAfPluginUsbCommonPrint(...) emberAfPrint(EMBER_AF_PRINT_PLUGIN_USB_COMMON, __VA_ARGS__)
#define emberAfPluginUsbCommonPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PLUGIN_USB_COMMON,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPluginUsbCommonFlush()
#define emberAfPluginUsbCommonDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PLUGIN_USB_COMMON) ) { x; }
#define emberAfPluginUsbCommonPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PLUGIN_USB_COMMON, (buffer), (len), (withSpace))
#define emberAfPluginUsbCommonPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PLUGIN_USB_COMMON, (buffer))
#else
#define emberAfPluginUsbCommonPrint(...)
#define emberAfPluginUsbCommonPrintln(...)
#define emberAfPluginUsbCommonFlush()
#define emberAfPluginUsbCommonDebugExec(x)
#define emberAfPluginUsbCommonPrintBuffer(buffer, len, withSpace)
#define emberAfPluginUsbCommonPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_USB_COMMON)
