...
class RM_Enum_WDOG_CTRL_CLKSEL(Base_RM_Enum):
    def __init__(self, label):
        ...
        zz_desc['LFXO'] = ""
        super(RM_Enum_WDOG_CTRL_CLKSEL, self).__init__(
            label,
            zz_edict,
            zz_desc)
...
class RM_Enum_WDOG_PCH0_PRSCTRL_PRSSEL(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_desc['PRSCH11'] = ""
        super(RM_Enum_WDOG_PCH0_PRSCTRL_PRSSEL, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_WDOG_PCH1_PRSCTRL_PRSSEL(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['PRSCH11'] = self.PRSCH11
        zz_desc['PRSCH11'] = ""
        super(RM_Enum_WDOG_PCH1_PRSCTRL_PRSSEL, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
