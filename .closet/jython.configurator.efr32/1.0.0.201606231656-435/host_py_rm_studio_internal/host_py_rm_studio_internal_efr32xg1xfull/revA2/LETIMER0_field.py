...
class RM_Field_LETIMER0_CTRL_RTCC0TEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_LETIMER0_CTRL_RTCC0TEN, self).__init__(register,
            'RTCC0TEN', 'LETIMER0.CTRL.RTCC0TEN', 'read-write',
            "",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_LETIMER0_CTRL_RTCC1TEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_LETIMER0_CTRL_RTCC1TEN, self).__init__(register,
            'RTCC1TEN', 'LETIMER0.CTRL.RTCC1TEN', 'read-write',
            "",
            11, 1)
        self.__dict__['zz_frozen'] = True
