...
class RM_Enum_ACMP0_CTRL_DUTYFSEL(Base_RM_Enum):
    def __init__(self, label):
        ...
        zz_edict['F3'] = self.F3
        zz_desc['F3'] = ""
        super(RM_Enum_ACMP0_CTRL_DUTYFSEL, self).__init__(
            label,
            zz_edict,
            zz_desc)
...
class RM_Enum_ACMP0_INPUTSEL_POSSEL(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_desc['VSS'] = ""
        super(RM_Enum_ACMP0_INPUTSEL_POSSEL, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_ACMP0_INPUTSEL_NEGSEL(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['VSS'] = self.VSS
        zz_desc['VSS'] = ""
        super(RM_Enum_ACMP0_INPUTSEL_NEGSEL, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
