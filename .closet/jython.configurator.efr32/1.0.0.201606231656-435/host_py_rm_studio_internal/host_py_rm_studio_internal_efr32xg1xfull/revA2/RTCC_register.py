...
class RM_Register_RTCC_CTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.BUMODETSEN = RM_Field_RTCC_CTRL_BUMODETSEN(self)
        self.zz_fdict['BUMODETSEN'] = self.BUMODETSEN
...
class RM_Register_RTCC_STATUS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RTCC_STATUS, self).__init__(rmio, label,
            0x40042000, 0x028,
            'STATUS', 'RTCC.STATUS', 'read-only',
            "",
            0x00000000, 0x00000001)

        self.BUMODETS = RM_Field_RTCC_STATUS_BUMODETS(self)
        self.zz_fdict['BUMODETS'] = self.BUMODETS
        self.__dict__['zz_frozen'] = True
