...
class RM_Field_MSC_LVEN_LVE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_LVEN_LVE, self).__init__(register,
            'LVE', 'MSC.LVEN.LVE', 'read-write',
            "",
            0, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MSC_DOUT0_DOUT0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_DOUT0_DOUT0, self).__init__(register,
            'DOUT0', 'MSC.DOUT0.DOUT0', 'read-only',
            "",
            0, 32)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_DOUT1_DOUT1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_DOUT1_DOUT1, self).__init__(register,
            'DOUT1', 'MSC.DOUT1.DOUT1', 'read-only',
            "",
            0, 32)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR0_REPADDR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR0_REPADDR, self).__init__(register,
            'REPADDR', 'MSC.REPADDR0.REPADDR', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR0_REPVALID(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR0_REPVALID, self).__init__(register,
            'REPVALID', 'MSC.REPADDR0.REPVALID', 'read-write',
            "",
            31, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR1_REPADDR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR1_REPADDR, self).__init__(register,
            'REPADDR', 'MSC.REPADDR1.REPADDR', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR1_REPVALID(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR1_REPVALID, self).__init__(register,
            'REPVALID', 'MSC.REPADDR1.REPVALID', 'read-write',
            "",
            31, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR2_REPADDR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR2_REPADDR, self).__init__(register,
            'REPADDR', 'MSC.REPADDR2.REPADDR', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR2_REPVALID(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR2_REPVALID, self).__init__(register,
            'REPVALID', 'MSC.REPADDR2.REPVALID', 'read-write',
            "",
            31, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR3_REPADDR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR3_REPADDR, self).__init__(register,
            'REPADDR', 'MSC.REPADDR3.REPADDR', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR3_REPVALID(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR3_REPVALID, self).__init__(register,
            'REPVALID', 'MSC.REPADDR3.REPVALID', 'read-write',
            "",
            31, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR4_REPADDR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR4_REPADDR, self).__init__(register,
            'REPADDR', 'MSC.REPADDR4.REPADDR', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR4_REPVALID(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR4_REPVALID, self).__init__(register,
            'REPVALID', 'MSC.REPADDR4.REPVALID', 'read-write',
            "",
            31, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR5_REPADDR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR5_REPADDR, self).__init__(register,
            'REPADDR', 'MSC.REPADDR5.REPADDR', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR5_REPVALID(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR5_REPVALID, self).__init__(register,
            'REPVALID', 'MSC.REPADDR5.REPVALID', 'read-write',
            "",
            31, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR6_REPADDR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR6_REPADDR, self).__init__(register,
            'REPADDR', 'MSC.REPADDR6.REPADDR', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR6_REPVALID(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR6_REPVALID, self).__init__(register,
            'REPVALID', 'MSC.REPADDR6.REPVALID', 'read-write',
            "",
            31, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR7_REPADDR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR7_REPADDR, self).__init__(register,
            'REPADDR', 'MSC.REPADDR7.REPADDR', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True


class RM_Field_MSC_REPADDR7_REPVALID(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MSC_REPADDR7_REPVALID, self).__init__(register,
            'REPVALID', 'MSC.REPADDR7.REPVALID', 'read-write',
            "",
            31, 1)
        self.__dict__['zz_frozen'] = True
