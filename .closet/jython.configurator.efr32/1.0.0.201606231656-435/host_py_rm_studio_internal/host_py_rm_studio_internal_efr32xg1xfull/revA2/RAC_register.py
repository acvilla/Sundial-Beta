...
class RM_Register_RAC_LNAMIXCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        #print("WARNING: Aliasing field '2P4BANDWIDTH' to 'RF2P4BANDWIDTH'")
        self.RF2P4BANDWIDTH = RM_Field_RAC_LNAMIXCTRL_2P4BANDWIDTH(self)
...
class RM_Register_RAC_PACTRL0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        #print("WARNING: Aliasing field '2P4PASEL' to 'RF2P4PASEL'")
        self.RF2P4PASEL = RM_Field_RAC_PACTRL0_2P4PASEL(self)
        self.zz_fdict['RF2P4PASEL'] = self.RF2P4PASEL
        #print("WARNING: Aliasing field '2P4PAVDDSEL' to 'RF2P4PAVDDSEL'")
        self.RF2P4PAVDDSEL = RM_Field_RAC_PACTRL0_2P4PAVDDSEL(self)
        self.zz_fdict['RF2P4PAVDDSEL'] = self.RF2P4PAVDDSEL
        #print("WARNING: Aliasing field '2P4RFVDDSEL' to 'RF2P4RFVDDSEL'")
        self.RF2P4RFVDDSEL = RM_Field_RAC_PACTRL0_2P4RFVDDSEL(self)
        ...
        #print("WARNING: Aliasing field '2P4VDDPADET' to 'RF2P4VDDPADET'")
        self.RF2P4VDDPADET = RM_Field_RAC_PACTRL0_2P4VDDPADET(self)
...
class RM_Register_RAC_PABIASCTRL1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        #print("WARNING: Aliasing field '2P4VDDPATHRESHOLD' to 'RF2P4VDDPATHRESHOLD'")
        self.RF2P4VDDPATHRESHOLD = RM_Field_RAC_PABIASCTRL1_2P4VDDPATHRESHOLD(self)
