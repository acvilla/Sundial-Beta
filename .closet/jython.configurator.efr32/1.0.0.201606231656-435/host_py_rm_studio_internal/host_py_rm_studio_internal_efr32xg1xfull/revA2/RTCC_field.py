...
class RM_Field_RTCC_CTRL_BUMODETSEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RTCC_CTRL_BUMODETSEN, self).__init__(register,
            'BUMODETSEN', 'RTCC.CTRL.BUMODETSEN', 'read-write',
            "",
            14, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RTCC_STATUS_BUMODETS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RTCC_STATUS_BUMODETS, self).__init__(register,
            'BUMODETS', 'RTCC.STATUS.BUMODETS', 'read-only',
            "",
            0, 1)
        self.__dict__['zz_frozen'] = True
