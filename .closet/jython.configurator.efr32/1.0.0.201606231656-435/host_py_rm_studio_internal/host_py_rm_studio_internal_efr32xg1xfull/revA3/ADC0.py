...
class RM_Peripheral_ADC0(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.SCANCHCONF = RM_Register_ADC0_SCANCHCONF(self.zz_rmio, self.zz_label)
        self.zz_rdict['SCANCHCONF'] = self.SCANCHCONF
        self.SCANNSEL = RM_Register_ADC0_SCANNSEL(self.zz_rmio, self.zz_label)
        self.zz_rdict['SCANNSEL'] = self.SCANNSEL
        ...
        self.BUSREQ = RM_Register_ADC0_BUSREQ(self.zz_rmio, self.zz_label)
        self.zz_rdict['BUSREQ'] = self.BUSREQ
        self.BUSCONFLICT = RM_Register_ADC0_BUSCONFLICT(self.zz_rmio, self.zz_label)
