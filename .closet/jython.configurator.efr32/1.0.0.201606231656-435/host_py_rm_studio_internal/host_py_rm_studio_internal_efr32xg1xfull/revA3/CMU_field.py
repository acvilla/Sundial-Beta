...
class RM_Field_CMU_HFXOCTRL_KEEPWARM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_HFXOCTRL_KEEPWARM, self).__init__(register,
            'KEEPWARM', 'CMU.HFXOCTRL.KEEPWARM', 'read-write',
            "",
            11, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_CMU_HFXOSTARTUPCTRL_IBTRIMXOCOREWARM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_HFXOSTARTUPCTRL_IBTRIMXOCOREWARM, self).__init__(register,
            'IBTRIMXOCOREWARM', 'CMU.HFXOSTARTUPCTRL.IBTRIMXOCOREWARM', 'read-write',
            "",
            21, 7)
        self.__dict__['zz_frozen'] = True


class RM_Field_CMU_HFXOSTARTUPCTRL_REGISHWARM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_HFXOSTARTUPCTRL_REGISHWARM, self).__init__(register,
            'REGISHWARM', 'CMU.HFXOSTARTUPCTRL.REGISHWARM', 'read-write',
            "",
            28, 4)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_CMU_HFXOTIMEOUTCTRL_WARMSTEADYTIMEOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_HFXOTIMEOUTCTRL_WARMSTEADYTIMEOUT, self).__init__(register,
            'WARMSTEADYTIMEOUT', 'CMU.HFXOTIMEOUTCTRL.WARMSTEADYTIMEOUT', 'read-write',
            "",
            8, 4,
            RM_Enum_CMU_HFXOTIMEOUTCTRL_WARMSTEADYTIMEOUT(register.zz_label))
        self.__dict__['zz_frozen'] = True
...
class RM_Field_CMU_STATUS_HFXOWARMS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_STATUS_HFXOWARMS, self).__init__(register,
            'HFXOWARMS', 'CMU.STATUS.HFXOWARMS', 'read-only',
            "",
            20, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_CMU_HFBUSCLKEN0_CRYPTO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_HFBUSCLKEN0_CRYPTO, self).__init__(register,
            'CRYPTO', 'CMU.HFBUSCLKEN0.CRYPTO', 'read-write',
            "",
            1, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_CMU_HFRADIOCLKEN0_BUFC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_HFRADIOCLKEN0_BUFC, self).__init__(register,
            'BUFC', 'CMU.HFRADIOCLKEN0.BUFC', 'read-write',
            "",
            4, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_CMU_LFEPRESC0_RTCC(Base_RM_Field):
    def __init__(self, register):
        ...
        super(RM_Field_CMU_LFEPRESC0_RTCC, self).__init__(register,
            'RTCC', 'CMU.LFEPRESC0.RTCC', 'read-only',
            "",
            0, 4,
...
class RM_Field_CMU_LCDCTRL_FDIV(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_LCDCTRL_FDIV, self).__init__(register,
            'FDIV', 'CMU.LCDCTRL.FDIV', 'read-write',
            "",
            0, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_CMU_LCDCTRL_VBOOSTEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_LCDCTRL_VBOOSTEN, self).__init__(register,
            'VBOOSTEN', 'CMU.LCDCTRL.VBOOSTEN', 'read-write',
            "",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_CMU_LCDCTRL_VBFDIV(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_LCDCTRL_VBFDIV, self).__init__(register,
            'VBFDIV', 'CMU.LCDCTRL.VBFDIV', 'read-write',
            "",
            4, 3,
            RM_Enum_CMU_LCDCTRL_VBFDIV(register.zz_label))
        self.__dict__['zz_frozen'] = True
...
class RM_Field_CMU_ADCCTRL_CLKSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_ADCCTRL_CLKSEL, self).__init__(register,
            'CLKSEL', 'CMU.ADCCTRL.CLKSEL', 'read-write',
            "",
            4, 2,
            RM_Enum_CMU_ADCCTRL_CLKSEL(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_CMU_ADCCTRL_INV(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_ADCCTRL_INV, self).__init__(register,
            'INV', 'CMU.ADCCTRL.INV', 'read-write',
            "",
            8, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_CMU_HFBUSCLKENMASK0_CRYPTO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_HFBUSCLKENMASK0_CRYPTO, self).__init__(register,
            'CRYPTO', 'CMU.HFBUSCLKENMASK0.CRYPTO', 'read-write',
            "",
            1, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_CMU_HFRADIOCLKENMASK0_BUFC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_HFRADIOCLKENMASK0_BUFC, self).__init__(register,
            'BUFC', 'CMU.HFRADIOCLKENMASK0.BUFC', 'read-write',
            "",
            4, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_CMU_TEST_LEWSYNCDELAY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_TEST_LEWSYNCDELAY, self).__init__(register,
            'LEWSYNCDELAY', 'CMU.TEST.LEWSYNCDELAY', 'read-write',
            "",
            26, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_CMU_TESTLFRCOCTRL_VREFUPDATE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_CMU_TESTLFRCOCTRL_VREFUPDATE, self).__init__(register,
            'VREFUPDATE', 'CMU.TESTLFRCOCTRL.VREFUPDATE', 'read-write',
            "",
            8, 2,
            RM_Enum_CMU_TESTLFRCOCTRL_VREFUPDATE(register.zz_label))
        self.__dict__['zz_frozen'] = True
