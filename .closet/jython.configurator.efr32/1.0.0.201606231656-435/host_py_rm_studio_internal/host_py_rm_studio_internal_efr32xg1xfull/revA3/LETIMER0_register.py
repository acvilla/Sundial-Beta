...
class RM_Register_LETIMER0_CTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RTCC0TEN = RM_Field_LETIMER0_CTRL_RTCC0TEN(self)
        self.zz_fdict['RTCC0TEN'] = self.RTCC0TEN
        self.RTCC1TEN = RM_Field_LETIMER0_CTRL_RTCC1TEN(self)
        self.zz_fdict['RTCC1TEN'] = self.RTCC1TEN
