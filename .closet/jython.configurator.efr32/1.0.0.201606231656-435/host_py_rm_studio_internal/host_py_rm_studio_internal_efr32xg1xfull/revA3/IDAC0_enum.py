...
class RM_Enum_IDAC0_CTRL_OUTMODE(Base_RM_Enum):
    def __init__(self, label):
        ...
        zz_desc['BUS1YCH31'] = ""
        super(RM_Enum_IDAC0_CTRL_OUTMODE, self).__init__(
            label,
            zz_edict,
            zz_desc)
...
class RM_Enum_IDAC0_CTRL_PRSSEL(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_desc['PRSCH11'] = ""
        super(RM_Enum_IDAC0_CTRL_PRSSEL, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_IDAC0_CURPROG_RANGESEL(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        self.RANGE0 = 0x00000000
        zz_edict['RANGE0'] = self.RANGE0
        zz_desc['RANGE0'] = ""
        self.RANGE1 = 0x00000001
        zz_edict['RANGE1'] = self.RANGE1
        zz_desc['RANGE1'] = ""
        self.RANGE2 = 0x00000002
        zz_edict['RANGE2'] = self.RANGE2
        zz_desc['RANGE2'] = ""
        self.RANGE3 = 0x00000003
        zz_edict['RANGE3'] = self.RANGE3
        zz_desc['RANGE3'] = ""
        super(RM_Enum_IDAC0_CURPROG_RANGESEL, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_IDAC0_DUTYFREQSEL_REFRESHRATE(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_desc['E125HZ'] = ""
        super(RM_Enum_IDAC0_DUTYFREQSEL_REFRESHRATE, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
