...
class RM_Register_MSC_LVEN(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MSC_LVEN, self).__init__(rmio, label,
            0x400e0000, 0x060,
            'LVEN', 'MSC.LVEN', 'read-write',
            "",
            0x00000000, 0x00000001)

        self.LVE = RM_Field_MSC_LVEN_LVE(self)
        self.zz_fdict['LVE'] = self.LVE
        self.__dict__['zz_frozen'] = True
...
class RM_Register_MSC_DOUT0(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MSC_DOUT0, self).__init__(rmio, label,
            0x400e0000, 0x140,
            'DOUT0', 'MSC.DOUT0', 'read-only',
            "",
            0xFFFFFFFF, 0xFFFFFFFF)

        self.DOUT0 = RM_Field_MSC_DOUT0_DOUT0(self)
        self.zz_fdict['DOUT0'] = self.DOUT0
        self.__dict__['zz_frozen'] = True


class RM_Register_MSC_DOUT1(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MSC_DOUT1, self).__init__(rmio, label,
            0x400e0000, 0x144,
            'DOUT1', 'MSC.DOUT1', 'read-only',
            "",
            0xFFFFFFFF, 0xFFFFFFFF)

        self.DOUT1 = RM_Field_MSC_DOUT1_DOUT1(self)
        self.zz_fdict['DOUT1'] = self.DOUT1
        self.__dict__['zz_frozen'] = True


class RM_Register_MSC_REPADDR0(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MSC_REPADDR0, self).__init__(rmio, label,
            0x400e0000, 0x180,
            'REPADDR0', 'MSC.REPADDR0', 'read-write',
            "",
            0x00000000, 0x8000FFFF)

        self.REPADDR = RM_Field_MSC_REPADDR0_REPADDR(self)
        self.zz_fdict['REPADDR'] = self.REPADDR
        self.REPVALID = RM_Field_MSC_REPADDR0_REPVALID(self)
        self.zz_fdict['REPVALID'] = self.REPVALID
        self.__dict__['zz_frozen'] = True


class RM_Register_MSC_REPADDR1(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MSC_REPADDR1, self).__init__(rmio, label,
            0x400e0000, 0x184,
            'REPADDR1', 'MSC.REPADDR1', 'read-write',
            "",
            0x00000000, 0x8000FFFF)

        self.REPADDR = RM_Field_MSC_REPADDR1_REPADDR(self)
        self.zz_fdict['REPADDR'] = self.REPADDR
        self.REPVALID = RM_Field_MSC_REPADDR1_REPVALID(self)
        self.zz_fdict['REPVALID'] = self.REPVALID
        self.__dict__['zz_frozen'] = True


class RM_Register_MSC_REPADDR2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MSC_REPADDR2, self).__init__(rmio, label,
            0x400e0000, 0x188,
            'REPADDR2', 'MSC.REPADDR2', 'read-write',
            "",
            0x00000000, 0x8000FFFF)

        self.REPADDR = RM_Field_MSC_REPADDR2_REPADDR(self)
        self.zz_fdict['REPADDR'] = self.REPADDR
        self.REPVALID = RM_Field_MSC_REPADDR2_REPVALID(self)
        self.zz_fdict['REPVALID'] = self.REPVALID
        self.__dict__['zz_frozen'] = True


class RM_Register_MSC_REPADDR3(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MSC_REPADDR3, self).__init__(rmio, label,
            0x400e0000, 0x18C,
            'REPADDR3', 'MSC.REPADDR3', 'read-write',
            "",
            0x00000000, 0x8000FFFF)

        self.REPADDR = RM_Field_MSC_REPADDR3_REPADDR(self)
        self.zz_fdict['REPADDR'] = self.REPADDR
        self.REPVALID = RM_Field_MSC_REPADDR3_REPVALID(self)
        self.zz_fdict['REPVALID'] = self.REPVALID
        self.__dict__['zz_frozen'] = True


class RM_Register_MSC_REPADDR4(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MSC_REPADDR4, self).__init__(rmio, label,
            0x400e0000, 0x190,
            'REPADDR4', 'MSC.REPADDR4', 'read-write',
            "",
            0x00000000, 0x8000FFFF)

        self.REPADDR = RM_Field_MSC_REPADDR4_REPADDR(self)
        self.zz_fdict['REPADDR'] = self.REPADDR
        self.REPVALID = RM_Field_MSC_REPADDR4_REPVALID(self)
        self.zz_fdict['REPVALID'] = self.REPVALID
        self.__dict__['zz_frozen'] = True


class RM_Register_MSC_REPADDR5(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MSC_REPADDR5, self).__init__(rmio, label,
            0x400e0000, 0x194,
            'REPADDR5', 'MSC.REPADDR5', 'read-write',
            "",
            0x00000000, 0x8000FFFF)

        self.REPADDR = RM_Field_MSC_REPADDR5_REPADDR(self)
        self.zz_fdict['REPADDR'] = self.REPADDR
        self.REPVALID = RM_Field_MSC_REPADDR5_REPVALID(self)
        self.zz_fdict['REPVALID'] = self.REPVALID
        self.__dict__['zz_frozen'] = True


class RM_Register_MSC_REPADDR6(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MSC_REPADDR6, self).__init__(rmio, label,
            0x400e0000, 0x198,
            'REPADDR6', 'MSC.REPADDR6', 'read-write',
            "",
            0x00000000, 0x8000FFFF)

        self.REPADDR = RM_Field_MSC_REPADDR6_REPADDR(self)
        self.zz_fdict['REPADDR'] = self.REPADDR
        self.REPVALID = RM_Field_MSC_REPADDR6_REPVALID(self)
        self.zz_fdict['REPVALID'] = self.REPVALID
        self.__dict__['zz_frozen'] = True


class RM_Register_MSC_REPADDR7(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MSC_REPADDR7, self).__init__(rmio, label,
            0x400e0000, 0x19C,
            'REPADDR7', 'MSC.REPADDR7', 'read-write',
            "",
            0x00000000, 0x8000FFFF)

        self.REPADDR = RM_Field_MSC_REPADDR7_REPADDR(self)
        self.zz_fdict['REPADDR'] = self.REPADDR
        self.REPVALID = RM_Field_MSC_REPADDR7_REPVALID(self)
        self.zz_fdict['REPVALID'] = self.REPVALID
        self.__dict__['zz_frozen'] = True
