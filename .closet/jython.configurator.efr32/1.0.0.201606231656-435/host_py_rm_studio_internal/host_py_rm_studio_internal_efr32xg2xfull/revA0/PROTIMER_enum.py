...
class RM_Enum_PROTIMER_CTRL_PRECNTSRC(Base_RM_Enum):
    def __init__(self, label):
        ...
        zz_desc['CLOCK'] = ""
        self.UNUSED0 = 0x00000002
        zz_edict['UNUSED0'] = self.UNUSED0
        zz_desc['UNUSED0'] = ""
        self.UNUSED1 = 0x00000003
        zz_edict['UNUSED1'] = self.UNUSED1
        zz_desc['UNUSED1'] = ""
...
class RM_Enum_PROTIMER_CC0_CTRL_INSEL(Base_RM_Enum):
    def __init__(self, label):
        ...
        zz_edict['FDET0OR1'] = self.FDET0OR1
        zz_desc['FDET0OR1'] = ""
        self.MODSYNCSENT = 0x00000007
        zz_edict['MODSYNCSENT'] = self.MODSYNCSENT
        zz_desc['MODSYNCSENT'] = ""
