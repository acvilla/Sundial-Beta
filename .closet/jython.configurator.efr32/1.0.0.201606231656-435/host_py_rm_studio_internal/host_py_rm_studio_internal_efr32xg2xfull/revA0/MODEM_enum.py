...
class RM_Enum_MODEM_CTRL0_CODING(Base_RM_Enum):
    def __init__(self, label):
        ...
        zz_desc['DSSS'] = ""
        self.LINECODE = 0x00000003
        zz_edict['LINECODE'] = self.LINECODE
        zz_desc['LINECODE'] = ""
...
class RM_Enum_MODEM_CTRL2_DATAFILTER(Base_RM_Enum):
    def __init__(self, label):
        ...
        zz_desc['LONG'] = ""
        self.LEN6 = 0x00000004
        zz_edict['LEN6'] = self.LEN6
        zz_desc['LEN6'] = ""
        self.LEN7 = 0x00000005
        zz_edict['LEN7'] = self.LEN7
        zz_desc['LEN7'] = ""
        self.LEN8 = 0x00000006
        zz_edict['LEN8'] = self.LEN8
        zz_desc['LEN8'] = ""
        self.LEN9 = 0x00000007
        zz_edict['LEN9'] = self.LEN9
        zz_desc['LEN9'] = ""
...
class RM_Enum_MODEM_CTRL3_TSAMPMODE(Base_RM_Enum):
    def __init__(self, label):
        ...
        zz_edict['ON'] = self.ON
        zz_desc['ON'] = ""
        self.DIFF = 0x00000002
        zz_edict['DIFF'] = self.DIFF
        zz_desc['DIFF'] = ""
...
class RM_Enum_MODEM_CTRL6_ARW(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        self.SMALLWND = 0x00000000
        zz_edict['SMALLWND'] = self.SMALLWND
        zz_desc['SMALLWND'] = ""
        ...
        zz_desc['NEVER'] = ""
        self.PSABORT = 0x00000003
        zz_edict['PSABORT'] = self.PSABORT
        zz_desc['PSABORT'] = ""
        super(RM_Enum_MODEM_CTRL6_ARW, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_MODEM_DSATHD1_POWRELTHD(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['DISABLED'] = self.DISABLED
        zz_desc['DISABLED'] = ""
        self.MODE1 = 0x00000001
        zz_edict['MODE1'] = self.MODE1
        zz_desc['MODE1'] = ""
        self.MODE2 = 0x00000002
        zz_edict['MODE2'] = self.MODE2
        zz_desc['MODE2'] = ""
        self.MODE3 = 0x00000003
        zz_edict['MODE3'] = self.MODE3
        zz_desc['MODE3'] = ""
        super(RM_Enum_MODEM_DSATHD1_POWRELTHD, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_MODEM_DSACTRL_DSAMODE(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['DISABLED'] = self.DISABLED
        zz_desc['DISABLED'] = ""
        self.ENABLED = 0x00000001
        zz_edict['ENABLED'] = self.ENABLED
        zz_desc['ENABLED'] = ""
        super(RM_Enum_MODEM_DSACTRL_DSAMODE, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_MODEM_VTTRACK_FREQTRACKMODE(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['MODE3'] = self.MODE3
        zz_desc['MODE3'] = ""
        super(RM_Enum_MODEM_VTTRACK_FREQTRACKMODE, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_MODEM_VTTRACK_TIMGEAR(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        self.GEAR0 = 0x00000000
        zz_edict['GEAR0'] = self.GEAR0
        zz_desc['GEAR0'] = ""
        self.GEAR1 = 0x00000001
        zz_edict['GEAR1'] = self.GEAR1
        zz_desc['GEAR1'] = ""
        self.GEAR2 = 0x00000002
        zz_edict['GEAR2'] = self.GEAR2
        zz_desc['GEAR2'] = ""
        super(RM_Enum_MODEM_VTTRACK_TIMGEAR, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
