...
class RM_Peripheral_ACMP0(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.APORTREQ = RM_Register_ACMP0_APORTREQ(self.zz_rmio, self.zz_label)
        self.zz_rdict['APORTREQ'] = self.APORTREQ
        self.APORTCONFLICT = RM_Register_ACMP0_APORTCONFLICT(self.zz_rmio, self.zz_label)
        ...
        self.EXTIFCTRL = RM_Register_ACMP0_EXTIFCTRL(self.zz_rmio, self.zz_label)
