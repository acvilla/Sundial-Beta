...
class RM_Field_ACMP1_CTRL_REFRESHRATE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_CTRL_REFRESHRATE, self).__init__(register,
            'REFRESHRATE', 'ACMP1.CTRL.REFRESHRATE', 'read-write',
            "",
            4, 2,
            RM_Enum_ACMP1_CTRL_REFRESHRATE(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_CTRL_APORTXMASTERDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_CTRL_APORTXMASTERDIS, self).__init__(register,
            'APORTXMASTERDIS', 'ACMP1.CTRL.APORTXMASTERDIS', 'read-write',
            "",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_CTRL_APORTYMASTERDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_CTRL_APORTYMASTERDIS, self).__init__(register,
            'APORTYMASTERDIS', 'ACMP1.CTRL.APORTYMASTERDIS', 'read-write',
            "",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_CTRL_APORTVMASTERDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_CTRL_APORTVMASTERDIS, self).__init__(register,
            'APORTVMASTERDIS', 'ACMP1.CTRL.APORTVMASTERDIS', 'read-write',
            "",
            10, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_ACMP1_STATUS_APORTCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_STATUS_APORTCONFLICT, self).__init__(register,
            'APORTCONFLICT', 'ACMP1.STATUS.APORTCONFLICT', 'read-only',
            "",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_STATUS_EXTIFACT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_STATUS_EXTIFACT, self).__init__(register,
            'EXTIFACT', 'ACMP1.STATUS.EXTIFACT', 'read-only',
            "",
            3, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_ACMP1_IF_APORTCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_IF_APORTCONFLICT, self).__init__(register,
            'APORTCONFLICT', 'ACMP1.IF.APORTCONFLICT', 'read-only',
            "",
            2, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_ACMP1_IFS_APORTCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_IFS_APORTCONFLICT, self).__init__(register,
            'APORTCONFLICT', 'ACMP1.IFS.APORTCONFLICT', 'write-only',
            "",
            2, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_ACMP1_IFC_APORTCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_IFC_APORTCONFLICT, self).__init__(register,
            'APORTCONFLICT', 'ACMP1.IFC.APORTCONFLICT', 'write-only',
            "",
            2, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_ACMP1_IEN_APORTCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_IEN_APORTCONFLICT, self).__init__(register,
            'APORTCONFLICT', 'ACMP1.IEN.APORTCONFLICT', 'read-write',
            "",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTREQ_APORT0XREQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTREQ_APORT0XREQ, self).__init__(register,
            'APORT0XREQ', 'ACMP1.APORTREQ.APORT0XREQ', 'read-only',
            "",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTREQ_APORT0YREQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTREQ_APORT0YREQ, self).__init__(register,
            'APORT0YREQ', 'ACMP1.APORTREQ.APORT0YREQ', 'read-only',
            "",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTREQ_APORT1XREQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTREQ_APORT1XREQ, self).__init__(register,
            'APORT1XREQ', 'ACMP1.APORTREQ.APORT1XREQ', 'read-only',
            "",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTREQ_APORT1YREQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTREQ_APORT1YREQ, self).__init__(register,
            'APORT1YREQ', 'ACMP1.APORTREQ.APORT1YREQ', 'read-only',
            "",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTREQ_APORT2XREQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTREQ_APORT2XREQ, self).__init__(register,
            'APORT2XREQ', 'ACMP1.APORTREQ.APORT2XREQ', 'read-only',
            "",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTREQ_APORT2YREQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTREQ_APORT2YREQ, self).__init__(register,
            'APORT2YREQ', 'ACMP1.APORTREQ.APORT2YREQ', 'read-only',
            "",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTREQ_APORT3XREQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTREQ_APORT3XREQ, self).__init__(register,
            'APORT3XREQ', 'ACMP1.APORTREQ.APORT3XREQ', 'read-only',
            "",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTREQ_APORT3YREQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTREQ_APORT3YREQ, self).__init__(register,
            'APORT3YREQ', 'ACMP1.APORTREQ.APORT3YREQ', 'read-only',
            "",
            7, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTREQ_APORT4XREQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTREQ_APORT4XREQ, self).__init__(register,
            'APORT4XREQ', 'ACMP1.APORTREQ.APORT4XREQ', 'read-only',
            "",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTREQ_APORT4YREQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTREQ_APORT4YREQ, self).__init__(register,
            'APORT4YREQ', 'ACMP1.APORTREQ.APORT4YREQ', 'read-only',
            "",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTCONFLICT_APORT0XCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTCONFLICT_APORT0XCONFLICT, self).__init__(register,
            'APORT0XCONFLICT', 'ACMP1.APORTCONFLICT.APORT0XCONFLICT', 'read-only',
            "",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTCONFLICT_APORT0YCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTCONFLICT_APORT0YCONFLICT, self).__init__(register,
            'APORT0YCONFLICT', 'ACMP1.APORTCONFLICT.APORT0YCONFLICT', 'read-only',
            "",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTCONFLICT_APORT1XCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTCONFLICT_APORT1XCONFLICT, self).__init__(register,
            'APORT1XCONFLICT', 'ACMP1.APORTCONFLICT.APORT1XCONFLICT', 'read-only',
            "",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTCONFLICT_APORT1YCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTCONFLICT_APORT1YCONFLICT, self).__init__(register,
            'APORT1YCONFLICT', 'ACMP1.APORTCONFLICT.APORT1YCONFLICT', 'read-only',
            "",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTCONFLICT_APORT2XCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTCONFLICT_APORT2XCONFLICT, self).__init__(register,
            'APORT2XCONFLICT', 'ACMP1.APORTCONFLICT.APORT2XCONFLICT', 'read-only',
            "",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTCONFLICT_APORT2YCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTCONFLICT_APORT2YCONFLICT, self).__init__(register,
            'APORT2YCONFLICT', 'ACMP1.APORTCONFLICT.APORT2YCONFLICT', 'read-only',
            "",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTCONFLICT_APORT3XCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTCONFLICT_APORT3XCONFLICT, self).__init__(register,
            'APORT3XCONFLICT', 'ACMP1.APORTCONFLICT.APORT3XCONFLICT', 'read-only',
            "",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTCONFLICT_APORT3YCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTCONFLICT_APORT3YCONFLICT, self).__init__(register,
            'APORT3YCONFLICT', 'ACMP1.APORTCONFLICT.APORT3YCONFLICT', 'read-only',
            "",
            7, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTCONFLICT_APORT4XCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTCONFLICT_APORT4XCONFLICT, self).__init__(register,
            'APORT4XCONFLICT', 'ACMP1.APORTCONFLICT.APORT4XCONFLICT', 'read-only',
            "",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_APORTCONFLICT_APORT4YCONFLICT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_APORTCONFLICT_APORT4YCONFLICT, self).__init__(register,
            'APORT4YCONFLICT', 'ACMP1.APORTCONFLICT.APORT4YCONFLICT', 'read-only',
            "",
            9, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_ACMP1_EXTIFCTRL_EN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_EXTIFCTRL_EN, self).__init__(register,
            'EN', 'ACMP1.EXTIFCTRL.EN', 'read-write',
            "",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_ACMP1_EXTIFCTRL_APORTSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_ACMP1_EXTIFCTRL_APORTSEL, self).__init__(register,
            'APORTSEL', 'ACMP1.EXTIFCTRL.APORTSEL', 'read-write',
            "",
            4, 4,
            RM_Enum_ACMP1_EXTIFCTRL_APORTSEL(register.zz_label))
        self.__dict__['zz_frozen'] = True
