...
class RM_Register_GPIO_PA_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PA_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x028,
            'PA_OVTDIS', 'GPIO.PA_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PA_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_PB_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PB_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x058,
            'PB_OVTDIS', 'GPIO.PB_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PB_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_PC_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PC_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x088,
            'PC_OVTDIS', 'GPIO.PC_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PC_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_PD_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PD_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x0B8,
            'PD_OVTDIS', 'GPIO.PD_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PD_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_PE_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PE_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x0E8,
            'PE_OVTDIS', 'GPIO.PE_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PE_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_PF_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PF_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x118,
            'PF_OVTDIS', 'GPIO.PF_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PF_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_PG_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PG_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x148,
            'PG_OVTDIS', 'GPIO.PG_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PG_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_PH_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PH_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x178,
            'PH_OVTDIS', 'GPIO.PH_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PH_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_PI_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PI_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x1A8,
            'PI_OVTDIS', 'GPIO.PI_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PI_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_PJ_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PJ_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x1D8,
            'PJ_OVTDIS', 'GPIO.PJ_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PJ_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_PK_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PK_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x208,
            'PK_OVTDIS', 'GPIO.PK_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PK_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_PL_OVTDIS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_PL_OVTDIS, self).__init__(rmio, label,
            0x4000a000, 0x238,
            'PL_OVTDIS', 'GPIO.PL_OVTDIS', 'read-write',
            "",
            0x00000000, 0x0000FFFF)

        self.OVTDIS = RM_Field_GPIO_PL_OVTDIS_OVTDIS(self)
        self.zz_fdict['OVTDIS'] = self.OVTDIS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_EXTIPINSELL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_EXTIPINSELL, self).__init__(rmio, label,
            0x4000a000, 0x408,
            'EXTIPINSELL', 'GPIO.EXTIPINSELL', 'read-write',
            "",
            0x32103210, 0x33333333)

        self.EXTIPINSEL0 = RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL0(self)
        self.zz_fdict['EXTIPINSEL0'] = self.EXTIPINSEL0
        self.EXTIPINSEL1 = RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL1(self)
        self.zz_fdict['EXTIPINSEL1'] = self.EXTIPINSEL1
        self.EXTIPINSEL2 = RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL2(self)
        self.zz_fdict['EXTIPINSEL2'] = self.EXTIPINSEL2
        self.EXTIPINSEL3 = RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL3(self)
        self.zz_fdict['EXTIPINSEL3'] = self.EXTIPINSEL3
        self.EXTIPINSEL4 = RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL4(self)
        self.zz_fdict['EXTIPINSEL4'] = self.EXTIPINSEL4
        self.EXTIPINSEL5 = RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL5(self)
        self.zz_fdict['EXTIPINSEL5'] = self.EXTIPINSEL5
        self.EXTIPINSEL6 = RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL6(self)
        self.zz_fdict['EXTIPINSEL6'] = self.EXTIPINSEL6
        self.EXTIPINSEL7 = RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL7(self)
        self.zz_fdict['EXTIPINSEL7'] = self.EXTIPINSEL7
        self.__dict__['zz_frozen'] = True


class RM_Register_GPIO_EXTIPINSELH(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_EXTIPINSELH, self).__init__(rmio, label,
            0x4000a000, 0x40C,
            'EXTIPINSELH', 'GPIO.EXTIPINSELH', 'read-write',
            "",
            0x32103210, 0x33333333)

        self.EXTIPINSEL8 = RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL8(self)
        self.zz_fdict['EXTIPINSEL8'] = self.EXTIPINSEL8
        self.EXTIPINSEL9 = RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL9(self)
        self.zz_fdict['EXTIPINSEL9'] = self.EXTIPINSEL9
        self.EXTIPINSEL10 = RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL10(self)
        self.zz_fdict['EXTIPINSEL10'] = self.EXTIPINSEL10
        self.EXTIPINSEL11 = RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL11(self)
        self.zz_fdict['EXTIPINSEL11'] = self.EXTIPINSEL11
        self.EXTIPINSEL12 = RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL12(self)
        self.zz_fdict['EXTIPINSEL12'] = self.EXTIPINSEL12
        self.EXTIPINSEL13 = RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL13(self)
        self.zz_fdict['EXTIPINSEL13'] = self.EXTIPINSEL13
        self.EXTIPINSEL14 = RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL14(self)
        self.zz_fdict['EXTIPINSEL14'] = self.EXTIPINSEL14
        self.EXTIPINSEL15 = RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL15(self)
        self.zz_fdict['EXTIPINSEL15'] = self.EXTIPINSEL15
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_EXTILEVEL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        super(RM_Register_GPIO_EXTILEVEL, self).__init__(rmio, label,
            ...
            "",
            0x00000000, 0x13130000)

        self.EM4WU0 = RM_Field_GPIO_EXTILEVEL_EM4WU0(self)
        self.zz_fdict['EM4WU0'] = self.EM4WU0
        self.EM4WU1 = RM_Field_GPIO_EXTILEVEL_EM4WU1(self)
        self.zz_fdict['EM4WU1'] = self.EM4WU1
        self.EM4WU4 = RM_Field_GPIO_EXTILEVEL_EM4WU4(self)
        self.zz_fdict['EM4WU4'] = self.EM4WU4
        self.EM4WU8 = RM_Field_GPIO_EXTILEVEL_EM4WU8(self)
        self.zz_fdict['EM4WU8'] = self.EM4WU8
        self.EM4WU9 = RM_Field_GPIO_EXTILEVEL_EM4WU9(self)
        self.zz_fdict['EM4WU9'] = self.EM4WU9
        self.EM4WU12 = RM_Field_GPIO_EXTILEVEL_EM4WU12(self)
        self.zz_fdict['EM4WU12'] = self.EM4WU12
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_ROUTEPEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.ETMTCLKPEN = RM_Field_GPIO_ROUTEPEN_ETMTCLKPEN(self)
        self.zz_fdict['ETMTCLKPEN'] = self.ETMTCLKPEN
        self.ETMTD0PEN = RM_Field_GPIO_ROUTEPEN_ETMTD0PEN(self)
        self.zz_fdict['ETMTD0PEN'] = self.ETMTD0PEN
        self.ETMTD1PEN = RM_Field_GPIO_ROUTEPEN_ETMTD1PEN(self)
        self.zz_fdict['ETMTD1PEN'] = self.ETMTD1PEN
        self.ETMTD2PEN = RM_Field_GPIO_ROUTEPEN_ETMTD2PEN(self)
        self.zz_fdict['ETMTD2PEN'] = self.ETMTD2PEN
        self.ETMTD3PEN = RM_Field_GPIO_ROUTEPEN_ETMTD3PEN(self)
        self.zz_fdict['ETMTD3PEN'] = self.ETMTD3PEN
        self.__dict__['zz_frozen'] = True
...
class RM_Register_GPIO_ROUTELOC1(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_GPIO_ROUTELOC1, self).__init__(rmio, label,
            0x4000a000, 0x448,
            'ROUTELOC1', 'GPIO.ROUTELOC1', 'read-write',
            "",
            0x00000000, 0xFFFFFF3F)

        self.ETMTCLKLOC = RM_Field_GPIO_ROUTELOC1_ETMTCLKLOC(self)
        self.zz_fdict['ETMTCLKLOC'] = self.ETMTCLKLOC
        self.ETMTD0LOC = RM_Field_GPIO_ROUTELOC1_ETMTD0LOC(self)
        self.zz_fdict['ETMTD0LOC'] = self.ETMTD0LOC
        self.ETMTD1LOC = RM_Field_GPIO_ROUTELOC1_ETMTD1LOC(self)
        self.zz_fdict['ETMTD1LOC'] = self.ETMTD1LOC
        self.ETMTD2LOC = RM_Field_GPIO_ROUTELOC1_ETMTD2LOC(self)
        self.zz_fdict['ETMTD2LOC'] = self.ETMTD2LOC
        self.ETMTD3LOC = RM_Field_GPIO_ROUTELOC1_ETMTD3LOC(self)
        self.zz_fdict['ETMTD3LOC'] = self.ETMTD3LOC
        self.__dict__['zz_frozen'] = True
