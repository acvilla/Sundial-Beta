...
class RM_Enum_AGC_GAINSTEPLIM_ADCATTENMODE(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_desc['DISABLE'] = ""
        self.NOTMAXGAIN = 0x00000001
        zz_edict['NOTMAXGAIN'] = self.NOTMAXGAIN
        zz_desc['NOTMAXGAIN'] = ""
        self.ADCUNSTABLE = 0x00000002
        zz_edict['ADCUNSTABLE'] = self.ADCUNSTABLE
        zz_desc['ADCUNSTABLE'] = ""
        self.STABILITYANDGAIN = 0x00000003
        zz_edict['STABILITYANDGAIN'] = self.STABILITYANDGAIN
        zz_desc['STABILITYANDGAIN'] = ""
        super(RM_Enum_AGC_GAINSTEPLIM_ADCATTENMODE, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
