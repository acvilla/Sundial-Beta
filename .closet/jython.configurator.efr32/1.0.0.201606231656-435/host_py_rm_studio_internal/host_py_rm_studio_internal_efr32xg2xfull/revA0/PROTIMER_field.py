...
class RM_Field_PROTIMER_ETSI_ETSIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_ETSI_ETSIEN, self).__init__(register,
            'ETSIEN', 'PROTIMER.ETSI.ETSIEN', 'read-write',
            "",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_ETSI_GRANULARLESSTHANRXWARM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_ETSI_GRANULARLESSTHANRXWARM, self).__init__(register,
            'GRANULARLESSTHANRXWARM', 'PROTIMER.ETSI.GRANULARLESSTHANRXWARM', 'read-write',
            "",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_ETSI_RXWARMTHLD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_ETSI_RXWARMTHLD, self).__init__(register,
            'RXWARMTHLD', 'PROTIMER.ETSI.RXWARMTHLD', 'read-write',
            "",
            2, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_ETSI_CCAFIXED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_ETSI_CCAFIXED, self).__init__(register,
            'CCAFIXED', 'PROTIMER.ETSI.CCAFIXED', 'read-write',
            "",
            7, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_LBTSTATE1_CCACNT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_LBTSTATE1_CCACNT, self).__init__(register,
            'CCACNT', 'PROTIMER.LBTSTATE1.CCACNT', 'read-write',
            "",
            0, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_LBTSTATE1_EXP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_LBTSTATE1_EXP, self).__init__(register,
            'EXP', 'PROTIMER.LBTSTATE1.EXP', 'read-write',
            "",
            4, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_LBTSTATE1_RETRYCNT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_LBTSTATE1_RETRYCNT, self).__init__(register,
            'RETRYCNT', 'PROTIMER.LBTSTATE1.RETRYCNT', 'read-write',
            "",
            8, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_RANDOMFW0_RANDOM0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_RANDOMFW0_RANDOM0, self).__init__(register,
            'RANDOM0', 'PROTIMER.RANDOMFW0.RANDOM0', 'read-write',
            "",
            0, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_RANDOMFW0_RANDOM1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_RANDOMFW0_RANDOM1, self).__init__(register,
            'RANDOM1', 'PROTIMER.RANDOMFW0.RANDOM1', 'read-write',
            "",
            9, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_RANDOMFW0_RANDOM2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_RANDOMFW0_RANDOM2, self).__init__(register,
            'RANDOM2', 'PROTIMER.RANDOMFW0.RANDOM2', 'read-write',
            "",
            18, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_RANDOMFW1_RANDOM3(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_RANDOMFW1_RANDOM3, self).__init__(register,
            'RANDOM3', 'PROTIMER.RANDOMFW1.RANDOM3', 'read-write',
            "",
            0, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_RANDOMFW1_RANDOM4(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_RANDOMFW1_RANDOM4, self).__init__(register,
            'RANDOM4', 'PROTIMER.RANDOMFW1.RANDOM4', 'read-write',
            "",
            9, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_RANDOMFW1_RANDOM5(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_RANDOMFW1_RANDOM5, self).__init__(register,
            'RANDOM5', 'PROTIMER.RANDOMFW1.RANDOM5', 'read-write',
            "",
            18, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_RANDOMFW2_RANDOM6(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_RANDOMFW2_RANDOM6, self).__init__(register,
            'RANDOM6', 'PROTIMER.RANDOMFW2.RANDOM6', 'read-write',
            "",
            0, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_PROTIMER_RANDOMFW2_RANDOM7(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_PROTIMER_RANDOMFW2_RANDOM7, self).__init__(register,
            'RANDOM7', 'PROTIMER.RANDOMFW2.RANDOM7', 'read-write',
            "",
            9, 9)
        self.__dict__['zz_frozen'] = True
