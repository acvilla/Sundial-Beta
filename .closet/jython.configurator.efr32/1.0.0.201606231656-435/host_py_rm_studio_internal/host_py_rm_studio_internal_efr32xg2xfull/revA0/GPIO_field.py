...
class RM_Field_GPIO_PA_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PA_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PA_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_PB_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PB_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PB_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_PC_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PC_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PC_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_PD_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PD_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PD_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_PE_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PE_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PE_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_PF_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PF_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PF_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_PG_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PG_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PG_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_PH_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PH_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PH_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_PI_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PI_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PI_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_PJ_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PJ_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PJ_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_PK_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PK_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PK_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_PL_OVTDIS_OVTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_PL_OVTDIS_OVTDIS, self).__init__(register,
            'OVTDIS', 'GPIO.PL_OVTDIS.OVTDIS', 'read-write',
            "",
            0, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL0, self).__init__(register,
            'EXTIPINSEL0', 'GPIO.EXTIPINSELL.EXTIPINSEL0', 'read-write',
            "",
            0, 2,
            RM_Enum_GPIO_EXTIPINSELL_EXTIPINSEL0(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL1, self).__init__(register,
            'EXTIPINSEL1', 'GPIO.EXTIPINSELL.EXTIPINSEL1', 'read-write',
            "",
            4, 2,
            RM_Enum_GPIO_EXTIPINSELL_EXTIPINSEL1(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL2, self).__init__(register,
            'EXTIPINSEL2', 'GPIO.EXTIPINSELL.EXTIPINSEL2', 'read-write',
            "",
            8, 2,
            RM_Enum_GPIO_EXTIPINSELL_EXTIPINSEL2(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL3(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL3, self).__init__(register,
            'EXTIPINSEL3', 'GPIO.EXTIPINSELL.EXTIPINSEL3', 'read-write',
            "",
            12, 2,
            RM_Enum_GPIO_EXTIPINSELL_EXTIPINSEL3(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL4(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL4, self).__init__(register,
            'EXTIPINSEL4', 'GPIO.EXTIPINSELL.EXTIPINSEL4', 'read-write',
            "",
            16, 2,
            RM_Enum_GPIO_EXTIPINSELL_EXTIPINSEL4(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL5(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL5, self).__init__(register,
            'EXTIPINSEL5', 'GPIO.EXTIPINSELL.EXTIPINSEL5', 'read-write',
            "",
            20, 2,
            RM_Enum_GPIO_EXTIPINSELL_EXTIPINSEL5(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL6(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL6, self).__init__(register,
            'EXTIPINSEL6', 'GPIO.EXTIPINSELL.EXTIPINSEL6', 'read-write',
            "",
            24, 2,
            RM_Enum_GPIO_EXTIPINSELL_EXTIPINSEL6(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL7(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELL_EXTIPINSEL7, self).__init__(register,
            'EXTIPINSEL7', 'GPIO.EXTIPINSELL.EXTIPINSEL7', 'read-write',
            "",
            28, 2,
            RM_Enum_GPIO_EXTIPINSELL_EXTIPINSEL7(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL8(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL8, self).__init__(register,
            'EXTIPINSEL8', 'GPIO.EXTIPINSELH.EXTIPINSEL8', 'read-write',
            "",
            0, 2,
            RM_Enum_GPIO_EXTIPINSELH_EXTIPINSEL8(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL9(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL9, self).__init__(register,
            'EXTIPINSEL9', 'GPIO.EXTIPINSELH.EXTIPINSEL9', 'read-write',
            "",
            4, 2,
            RM_Enum_GPIO_EXTIPINSELH_EXTIPINSEL9(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL10(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL10, self).__init__(register,
            'EXTIPINSEL10', 'GPIO.EXTIPINSELH.EXTIPINSEL10', 'read-write',
            "",
            8, 2,
            RM_Enum_GPIO_EXTIPINSELH_EXTIPINSEL10(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL11(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL11, self).__init__(register,
            'EXTIPINSEL11', 'GPIO.EXTIPINSELH.EXTIPINSEL11', 'read-write',
            "",
            12, 2,
            RM_Enum_GPIO_EXTIPINSELH_EXTIPINSEL11(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL12(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL12, self).__init__(register,
            'EXTIPINSEL12', 'GPIO.EXTIPINSELH.EXTIPINSEL12', 'read-write',
            "",
            16, 2,
            RM_Enum_GPIO_EXTIPINSELH_EXTIPINSEL12(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL13(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL13, self).__init__(register,
            'EXTIPINSEL13', 'GPIO.EXTIPINSELH.EXTIPINSEL13', 'read-write',
            "",
            20, 2,
            RM_Enum_GPIO_EXTIPINSELH_EXTIPINSEL13(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL14(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL14, self).__init__(register,
            'EXTIPINSEL14', 'GPIO.EXTIPINSELH.EXTIPINSEL14', 'read-write',
            "",
            24, 2,
            RM_Enum_GPIO_EXTIPINSELH_EXTIPINSEL14(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL15(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTIPINSELH_EXTIPINSEL15, self).__init__(register,
            'EXTIPINSEL15', 'GPIO.EXTIPINSELH.EXTIPINSEL15', 'read-write',
            "",
            28, 2,
            RM_Enum_GPIO_EXTIPINSELH_EXTIPINSEL15(register.zz_label))
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_EXTILEVEL_EM4WU0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTILEVEL_EM4WU0, self).__init__(register,
            'EM4WU0', 'GPIO.EXTILEVEL.EM4WU0', 'read-write',
            "",
            16, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTILEVEL_EM4WU1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTILEVEL_EM4WU1, self).__init__(register,
            'EM4WU1', 'GPIO.EXTILEVEL.EM4WU1', 'read-write',
            "",
            17, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTILEVEL_EM4WU4(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTILEVEL_EM4WU4, self).__init__(register,
            'EM4WU4', 'GPIO.EXTILEVEL.EM4WU4', 'read-write',
            "",
            20, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTILEVEL_EM4WU8(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTILEVEL_EM4WU8, self).__init__(register,
            'EM4WU8', 'GPIO.EXTILEVEL.EM4WU8', 'read-write',
            "",
            24, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTILEVEL_EM4WU9(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTILEVEL_EM4WU9, self).__init__(register,
            'EM4WU9', 'GPIO.EXTILEVEL.EM4WU9', 'read-write',
            "",
            25, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_EXTILEVEL_EM4WU12(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_EXTILEVEL_EM4WU12, self).__init__(register,
            'EM4WU12', 'GPIO.EXTILEVEL.EM4WU12', 'read-write',
            "",
            28, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_ROUTEPEN_ETMTCLKPEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_ROUTEPEN_ETMTCLKPEN, self).__init__(register,
            'ETMTCLKPEN', 'GPIO.ROUTEPEN.ETMTCLKPEN', 'read-write',
            "",
            16, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_ROUTEPEN_ETMTD0PEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_ROUTEPEN_ETMTD0PEN, self).__init__(register,
            'ETMTD0PEN', 'GPIO.ROUTEPEN.ETMTD0PEN', 'read-write',
            "",
            17, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_ROUTEPEN_ETMTD1PEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_ROUTEPEN_ETMTD1PEN, self).__init__(register,
            'ETMTD1PEN', 'GPIO.ROUTEPEN.ETMTD1PEN', 'read-write',
            "",
            18, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_ROUTEPEN_ETMTD2PEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_ROUTEPEN_ETMTD2PEN, self).__init__(register,
            'ETMTD2PEN', 'GPIO.ROUTEPEN.ETMTD2PEN', 'read-write',
            "",
            19, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_ROUTEPEN_ETMTD3PEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_ROUTEPEN_ETMTD3PEN, self).__init__(register,
            'ETMTD3PEN', 'GPIO.ROUTEPEN.ETMTD3PEN', 'read-write',
            "",
            20, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_GPIO_ROUTELOC1_ETMTCLKLOC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_ROUTELOC1_ETMTCLKLOC, self).__init__(register,
            'ETMTCLKLOC', 'GPIO.ROUTELOC1.ETMTCLKLOC', 'read-write',
            "",
            0, 6,
            RM_Enum_GPIO_ROUTELOC1_ETMTCLKLOC(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_ROUTELOC1_ETMTD0LOC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_ROUTELOC1_ETMTD0LOC, self).__init__(register,
            'ETMTD0LOC', 'GPIO.ROUTELOC1.ETMTD0LOC', 'read-write',
            "",
            8, 6,
            RM_Enum_GPIO_ROUTELOC1_ETMTD0LOC(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_ROUTELOC1_ETMTD1LOC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_ROUTELOC1_ETMTD1LOC, self).__init__(register,
            'ETMTD1LOC', 'GPIO.ROUTELOC1.ETMTD1LOC', 'read-write',
            "",
            14, 6,
            RM_Enum_GPIO_ROUTELOC1_ETMTD1LOC(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_ROUTELOC1_ETMTD2LOC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_ROUTELOC1_ETMTD2LOC, self).__init__(register,
            'ETMTD2LOC', 'GPIO.ROUTELOC1.ETMTD2LOC', 'read-write',
            "",
            20, 6,
            RM_Enum_GPIO_ROUTELOC1_ETMTD2LOC(register.zz_label))
        self.__dict__['zz_frozen'] = True


class RM_Field_GPIO_ROUTELOC1_ETMTD3LOC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_GPIO_ROUTELOC1_ETMTD3LOC, self).__init__(register,
            'ETMTD3LOC', 'GPIO.ROUTELOC1.ETMTD3LOC', 'read-write',
            "",
            26, 6,
            RM_Enum_GPIO_ROUTELOC1_ETMTD3LOC(register.zz_label))
        self.__dict__['zz_frozen'] = True
