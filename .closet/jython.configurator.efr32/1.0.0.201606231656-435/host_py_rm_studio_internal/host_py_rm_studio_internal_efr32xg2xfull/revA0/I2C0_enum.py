...
class RM_Enum_I2C0_CTRL_CLHR(Base_RM_Enum):
    def __init__(self, label):
        ...
        zz_desc['FAST'] = ""
        super(RM_Enum_I2C0_CTRL_CLHR, self).__init__(
            label,
            zz_edict,
            zz_desc)
...
class RM_Enum_I2C0_CTRL_BITO(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_desc['E160PCC'] = ""
        super(RM_Enum_I2C0_CTRL_BITO, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_I2C0_CTRL_CLTO(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_desc['E1024PCC'] = ""
        super(RM_Enum_I2C0_CTRL_CLTO, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_I2C0_STATE_STATE(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_desc['DATAACK'] = ""
        super(RM_Enum_I2C0_STATE_STATE, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_I2C0_ROUTELOC0_SDALOC(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_desc['LOC31'] = ""
        super(RM_Enum_I2C0_ROUTELOC0_SDALOC, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_I2C0_ROUTELOC0_SCLLOC(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['LOC31'] = self.LOC31
        zz_desc['LOC31'] = ""
        super(RM_Enum_I2C0_ROUTELOC0_SCLLOC, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
