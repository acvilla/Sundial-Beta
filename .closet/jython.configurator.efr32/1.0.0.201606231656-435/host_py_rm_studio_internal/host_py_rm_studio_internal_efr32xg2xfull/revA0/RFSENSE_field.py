...
class RM_Field_RFSENSE_CTRL_RF2G4EN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFSENSE_CTRL_RF2G4EN, self).__init__(register,
            'RF2G4EN', 'RFSENSE.CTRL.RF2G4EN', 'read-write',
            "",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RFSENSE_CTRL_RFSUBGEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RFSENSE_CTRL_RFSUBGEN, self).__init__(register,
            'RFSUBGEN', 'RFSENSE.CTRL.RFSUBGEN', 'read-write',
            "",
            1, 1)
        self.__dict__['zz_frozen'] = True
