...
class RM_Enum_CMU_LFRCOCTRL_VREFUPDATE(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_desc['E256CYCLES'] = ""
        super(RM_Enum_CMU_LFRCOCTRL_VREFUPDATE, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_CMU_DPLLCTRL_REFSEL(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['LFXO'] = self.LFXO
        zz_desc['LFXO'] = ""
        self.CLKIN0 = 0x00000003
        zz_edict['CLKIN0'] = self.CLKIN0
        zz_desc['CLKIN0'] = ""
        super(RM_Enum_CMU_DPLLCTRL_REFSEL, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_CMU_DBGCLKSEL_DBG(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        self.AUXHFRCO = 0x00000000
        zz_edict['AUXHFRCO'] = self.AUXHFRCO
        zz_desc['AUXHFRCO'] = ""
        self.HFCLK = 0x00000001
        zz_edict['HFCLK'] = self.HFCLK
        zz_desc['HFCLK'] = ""
        super(RM_Enum_CMU_DBGCLKSEL_DBG, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_CMU_HFCLKSEL_HF(Base_RM_Enum):
    def __init__(self, label):
        ...
        zz_edict['LFXO'] = self.LFXO
        zz_desc['LFXO'] = ""
        self.HFRCODIV2 = 0x00000005
        zz_edict['HFRCODIV2'] = self.HFRCODIV2
        zz_desc['HFRCODIV2'] = ""
        self.CLKIN0 = 0x00000007
        zz_edict['CLKIN0'] = self.CLKIN0
        zz_desc['CLKIN0'] = ""
...
class RM_Enum_CMU_HFPRESC_HFCLKLEPRESC(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        self.DIV2 = 0x00000000
        zz_edict['DIV2'] = self.DIV2
        zz_desc['DIV2'] = ""
        self.DIV4 = 0x00000001
        zz_edict['DIV4'] = self.DIV4
        zz_desc['DIV4'] = ""
        super(RM_Enum_CMU_HFPRESC_HFCLKLEPRESC, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_CMU_LFAPRESC0_LESENSE(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['DIV8'] = self.DIV8
        zz_desc['DIV8'] = ""
        super(RM_Enum_CMU_LFAPRESC0_LESENSE, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_CMU_LFBPRESC0_SYSTICK(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['DIV1'] = self.DIV1
        zz_desc['DIV1'] = ""
        super(RM_Enum_CMU_LFBPRESC0_SYSTICK, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_CMU_LFBPRESC0_CSEN(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        self.DIV16 = 0x00000000
        zz_edict['DIV16'] = self.DIV16
        zz_desc['DIV16'] = ""
        self.DIV32 = 0x00000001
        zz_edict['DIV32'] = self.DIV32
        zz_desc['DIV32'] = ""
        self.DIV64 = 0x00000002
        zz_edict['DIV64'] = self.DIV64
        zz_desc['DIV64'] = ""
        self.DIV128 = 0x00000003
        zz_edict['DIV128'] = self.DIV128
        zz_desc['DIV128'] = ""
        super(RM_Enum_CMU_LFBPRESC0_CSEN, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_CMU_HFRADIOALTPRESC_PRESC(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['NODIVISION'] = self.NODIVISION
        zz_desc['NODIVISION'] = ""
        super(RM_Enum_CMU_HFRADIOALTPRESC_PRESC, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_CMU_ADCCTRL_ADC0CLKSEL(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['HFSRCCLK'] = self.HFSRCCLK
        zz_desc['HFSRCCLK'] = ""
        super(RM_Enum_CMU_ADCCTRL_ADC0CLKSEL, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
...
class RM_Enum_CMU_ROUTELOC1_CLKIN0LOC(Base_RM_Enum):
    def __init__(self, label):
        self.__dict__['zz_frozen'] = False
        zz_edict = OrderedDict()
        zz_desc = {}
        ...
        zz_edict['LOC4'] = self.LOC4
        zz_desc['LOC4'] = ""
        super(RM_Enum_CMU_ROUTELOC1_CLKIN0LOC, self).__init__(
            label,
            zz_edict,
            zz_desc)
        self.__dict__['zz_frozen'] = True
