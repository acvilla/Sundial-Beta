...
class RM_Peripheral_PROTIMER(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.ETSI = RM_Register_PROTIMER_ETSI(self.zz_rmio, self.zz_label)
        self.zz_rdict['ETSI'] = self.ETSI
        self.LBTSTATE1 = RM_Register_PROTIMER_LBTSTATE1(self.zz_rmio, self.zz_label)
        self.zz_rdict['LBTSTATE1'] = self.LBTSTATE1
        self.RANDOMFW0 = RM_Register_PROTIMER_RANDOMFW0(self.zz_rmio, self.zz_label)
        self.zz_rdict['RANDOMFW0'] = self.RANDOMFW0
        self.RANDOMFW1 = RM_Register_PROTIMER_RANDOMFW1(self.zz_rmio, self.zz_label)
        self.zz_rdict['RANDOMFW1'] = self.RANDOMFW1
        self.RANDOMFW2 = RM_Register_PROTIMER_RANDOMFW2(self.zz_rmio, self.zz_label)
        self.zz_rdict['RANDOMFW2'] = self.RANDOMFW2
