...
class RM_Register_ACMP1_CTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.REFRESHRATE = RM_Field_ACMP1_CTRL_REFRESHRATE(self)
        self.zz_fdict['REFRESHRATE'] = self.REFRESHRATE
        self.APORTXMASTERDIS = RM_Field_ACMP1_CTRL_APORTXMASTERDIS(self)
        self.zz_fdict['APORTXMASTERDIS'] = self.APORTXMASTERDIS
        self.APORTYMASTERDIS = RM_Field_ACMP1_CTRL_APORTYMASTERDIS(self)
        self.zz_fdict['APORTYMASTERDIS'] = self.APORTYMASTERDIS
        self.APORTVMASTERDIS = RM_Field_ACMP1_CTRL_APORTVMASTERDIS(self)
...
class RM_Register_ACMP1_STATUS(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.APORTCONFLICT = RM_Field_ACMP1_STATUS_APORTCONFLICT(self)
        self.zz_fdict['APORTCONFLICT'] = self.APORTCONFLICT
        self.EXTIFACT = RM_Field_ACMP1_STATUS_EXTIFACT(self)
...
class RM_Register_ACMP1_IF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.APORTCONFLICT = RM_Field_ACMP1_IF_APORTCONFLICT(self)
        self.zz_fdict['APORTCONFLICT'] = self.APORTCONFLICT
        self.__dict__['zz_frozen'] = True
...
class RM_Register_ACMP1_IFS(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.zz_fdict['WARMUP'] = self.WARMUP
        self.APORTCONFLICT = RM_Field_ACMP1_IFS_APORTCONFLICT(self)
        self.zz_fdict['APORTCONFLICT'] = self.APORTCONFLICT
        self.__dict__['zz_frozen'] = True
...
class RM_Register_ACMP1_IFC(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.zz_fdict['WARMUP'] = self.WARMUP
        self.APORTCONFLICT = RM_Field_ACMP1_IFC_APORTCONFLICT(self)
        self.zz_fdict['APORTCONFLICT'] = self.APORTCONFLICT
        self.__dict__['zz_frozen'] = True
...
class RM_Register_ACMP1_IEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.zz_fdict['WARMUP'] = self.WARMUP
        self.APORTCONFLICT = RM_Field_ACMP1_IEN_APORTCONFLICT(self)
        self.zz_fdict['APORTCONFLICT'] = self.APORTCONFLICT
        self.__dict__['zz_frozen'] = True


class RM_Register_ACMP1_APORTREQ(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_ACMP1_APORTREQ, self).__init__(rmio, label,
            0x40000400, 0x020,
            'APORTREQ', 'ACMP1.APORTREQ', 'read-only',
            "",
            0x00000000, 0x000003FF)

        self.APORT0XREQ = RM_Field_ACMP1_APORTREQ_APORT0XREQ(self)
        self.zz_fdict['APORT0XREQ'] = self.APORT0XREQ
        self.APORT0YREQ = RM_Field_ACMP1_APORTREQ_APORT0YREQ(self)
        self.zz_fdict['APORT0YREQ'] = self.APORT0YREQ
        self.APORT1XREQ = RM_Field_ACMP1_APORTREQ_APORT1XREQ(self)
        self.zz_fdict['APORT1XREQ'] = self.APORT1XREQ
        self.APORT1YREQ = RM_Field_ACMP1_APORTREQ_APORT1YREQ(self)
        self.zz_fdict['APORT1YREQ'] = self.APORT1YREQ
        self.APORT2XREQ = RM_Field_ACMP1_APORTREQ_APORT2XREQ(self)
        self.zz_fdict['APORT2XREQ'] = self.APORT2XREQ
        self.APORT2YREQ = RM_Field_ACMP1_APORTREQ_APORT2YREQ(self)
        self.zz_fdict['APORT2YREQ'] = self.APORT2YREQ
        self.APORT3XREQ = RM_Field_ACMP1_APORTREQ_APORT3XREQ(self)
        self.zz_fdict['APORT3XREQ'] = self.APORT3XREQ
        self.APORT3YREQ = RM_Field_ACMP1_APORTREQ_APORT3YREQ(self)
        self.zz_fdict['APORT3YREQ'] = self.APORT3YREQ
        self.APORT4XREQ = RM_Field_ACMP1_APORTREQ_APORT4XREQ(self)
        self.zz_fdict['APORT4XREQ'] = self.APORT4XREQ
        self.APORT4YREQ = RM_Field_ACMP1_APORTREQ_APORT4YREQ(self)
        self.zz_fdict['APORT4YREQ'] = self.APORT4YREQ
        self.__dict__['zz_frozen'] = True


class RM_Register_ACMP1_APORTCONFLICT(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_ACMP1_APORTCONFLICT, self).__init__(rmio, label,
            0x40000400, 0x024,
            'APORTCONFLICT', 'ACMP1.APORTCONFLICT', 'read-only',
            "",
            0x00000000, 0x000003FF)

        self.APORT0XCONFLICT = RM_Field_ACMP1_APORTCONFLICT_APORT0XCONFLICT(self)
        self.zz_fdict['APORT0XCONFLICT'] = self.APORT0XCONFLICT
        self.APORT0YCONFLICT = RM_Field_ACMP1_APORTCONFLICT_APORT0YCONFLICT(self)
        self.zz_fdict['APORT0YCONFLICT'] = self.APORT0YCONFLICT
        self.APORT1XCONFLICT = RM_Field_ACMP1_APORTCONFLICT_APORT1XCONFLICT(self)
        self.zz_fdict['APORT1XCONFLICT'] = self.APORT1XCONFLICT
        self.APORT1YCONFLICT = RM_Field_ACMP1_APORTCONFLICT_APORT1YCONFLICT(self)
        self.zz_fdict['APORT1YCONFLICT'] = self.APORT1YCONFLICT
        self.APORT2XCONFLICT = RM_Field_ACMP1_APORTCONFLICT_APORT2XCONFLICT(self)
        self.zz_fdict['APORT2XCONFLICT'] = self.APORT2XCONFLICT
        self.APORT2YCONFLICT = RM_Field_ACMP1_APORTCONFLICT_APORT2YCONFLICT(self)
        self.zz_fdict['APORT2YCONFLICT'] = self.APORT2YCONFLICT
        self.APORT3XCONFLICT = RM_Field_ACMP1_APORTCONFLICT_APORT3XCONFLICT(self)
        self.zz_fdict['APORT3XCONFLICT'] = self.APORT3XCONFLICT
        self.APORT3YCONFLICT = RM_Field_ACMP1_APORTCONFLICT_APORT3YCONFLICT(self)
        self.zz_fdict['APORT3YCONFLICT'] = self.APORT3YCONFLICT
        self.APORT4XCONFLICT = RM_Field_ACMP1_APORTCONFLICT_APORT4XCONFLICT(self)
        self.zz_fdict['APORT4XCONFLICT'] = self.APORT4XCONFLICT
        self.APORT4YCONFLICT = RM_Field_ACMP1_APORTCONFLICT_APORT4YCONFLICT(self)
...
class RM_Register_ACMP1_EXTIFCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_ACMP1_EXTIFCTRL, self).__init__(rmio, label,
            0x40000400, 0x048,
            'EXTIFCTRL', 'ACMP1.EXTIFCTRL', 'read-write',
            "",
            0x00000000, 0x000000F1)

        self.EN = RM_Field_ACMP1_EXTIFCTRL_EN(self)
        self.zz_fdict['EN'] = self.EN
        self.APORTSEL = RM_Field_ACMP1_EXTIFCTRL_APORTSEL(self)
