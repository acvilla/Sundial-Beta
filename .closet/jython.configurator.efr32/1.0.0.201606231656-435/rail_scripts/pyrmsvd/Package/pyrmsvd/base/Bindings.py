...
class addressBlockType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='addressBlockType', fromsubclass_=False, pretty_print=True):
        ...
        if self.usage is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%susage>%s</%susage>%s' % (namespace_, self.gds_format_string(quote_xml(self.usage).encode(ExternalEncoding), input_name='usage'), namespace_, eol_))
...
class device(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='device', fromsubclass_=False, pretty_print=True):
        ...
        if self.addressUnitBits is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%saddressUnitBits>%s</%saddressUnitBits>%s' % (namespace_, self.gds_format_string(quote_xml(self.addressUnitBits).encode(ExternalEncoding), input_name='addressUnitBits'), namespace_, eol_))
        if self.width is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%swidth>%s</%swidth>%s' % (namespace_, self.gds_format_string(quote_xml(self.width).encode(ExternalEncoding), input_name='width'), namespace_, eol_))
        if self.size is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssize>%s</%ssize>%s' % (namespace_, self.gds_format_string(quote_xml(self.size).encode(ExternalEncoding), input_name='size'), namespace_, eol_))
        if self.access is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%saccess>%s</%saccess>%s' % (namespace_, self.gds_format_string(quote_xml(self.access).encode(ExternalEncoding), input_name='access'), namespace_, eol_))
        if self.resetValue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sresetValue>%s</%sresetValue>%s' % (namespace_, self.gds_format_string(quote_xml(self.resetValue).encode(ExternalEncoding), input_name='resetValue'), namespace_, eol_))
        if self.resetMask is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sresetMask>%s</%sresetMask>%s' % (namespace_, self.gds_format_string(quote_xml(self.resetMask).encode(ExternalEncoding), input_name='resetMask'), namespace_, eol_))
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.addressUnitBits is not None:
            showIndent(outfile, level)
            outfile.write('addressUnitBits=%s,\n' % quote_python(self.addressUnitBits).encode(ExternalEncoding))
        if self.width is not None:
            showIndent(outfile, level)
        ...
        if self.access is not None:
            showIndent(outfile, level)
            outfile.write('access=%s,\n' % quote_python(self.access).encode(ExternalEncoding))
        if self.resetValue is not None:
            showIndent(outfile, level)
            outfile.write('resetValue=%s,\n' % quote_python(self.resetValue).encode(ExternalEncoding))
        if self.resetMask is not None:
            showIndent(outfile, level)
            outfile.write('resetMask=%s,\n' % quote_python(self.resetMask).encode(ExternalEncoding))
        if self.peripherals is not None:
            showIndent(outfile, level)
...
class rangeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='rangeType', fromsubclass_=False, pretty_print=True):
        ...
        if self.minimum is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sminimum>%s</%sminimum>%s' % (namespace_, self.gds_format_string(quote_xml(self.minimum).encode(ExternalEncoding), input_name='minimum'), namespace_, eol_))
        if self.maximum is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smaximum>%s</%smaximum>%s' % (namespace_, self.gds_format_string(quote_xml(self.maximum).encode(ExternalEncoding), input_name='maximum'), namespace_, eol_))
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.minimum is not None:
            showIndent(outfile, level)
            outfile.write('minimum=%s,\n' % quote_python(self.minimum).encode(ExternalEncoding))
        if self.maximum is not None:
            showIndent(outfile, level)
            outfile.write('maximum=%s,\n' % quote_python(self.maximum).encode(ExternalEncoding))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class peripheralType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='peripheralType'):
        if self.derivedFrom is not None and 'derivedFrom' not in already_processed:
            ...
            outfile.write(' derivedFrom=%s' % (self.gds_format_string(quote_attrib(self.derivedFrom).encode(ExternalEncoding), input_name='derivedFrom'), ))
    def exportChildren(self, outfile, level, namespace_='', name_='peripheralType', fromsubclass_=False, pretty_print=True):
        ...
        if self.prependToName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sprependToName>%s</%sprependToName>%s' % (namespace_, self.gds_format_string(quote_xml(self.prependToName).encode(ExternalEncoding), input_name='prependToName'), namespace_, eol_))
        if self.appendToName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sappendToName>%s</%sappendToName>%s' % (namespace_, self.gds_format_string(quote_xml(self.appendToName).encode(ExternalEncoding), input_name='appendToName'), namespace_, eol_))
        if self.disableCondition is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdisableCondition>%s</%sdisableCondition>%s' % (namespace_, self.gds_format_string(quote_xml(self.disableCondition).encode(ExternalEncoding), input_name='disableCondition'), namespace_, eol_))
        if self.baseAddress is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sbaseAddress>%s</%sbaseAddress>%s' % (namespace_, self.gds_format_string(quote_xml(self.baseAddress).encode(ExternalEncoding), input_name='baseAddress'), namespace_, eol_))
        if self.size is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssize>%s</%ssize>%s' % (namespace_, self.gds_format_string(quote_xml(self.size).encode(ExternalEncoding), input_name='size'), namespace_, eol_))
        if self.access is not None:
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.prependToName is not None:
            showIndent(outfile, level)
            outfile.write('prependToName=%s,\n' % quote_python(self.prependToName).encode(ExternalEncoding))
        if self.appendToName is not None:
            showIndent(outfile, level)
            outfile.write('appendToName=%s,\n' % quote_python(self.appendToName).encode(ExternalEncoding))
        if self.disableCondition is not None:
            showIndent(outfile, level)
            outfile.write('disableCondition=%s,\n' % quote_python(self.disableCondition).encode(ExternalEncoding))
        if self.baseAddress is not None:
            showIndent(outfile, level)
            outfile.write('baseAddress=%s,\n' % quote_python(self.baseAddress).encode(ExternalEncoding))
        if self.size is not None:
            showIndent(outfile, level)
            outfile.write('size=%s,\n' % quote_python(self.size).encode(ExternalEncoding))
        if self.access is not None:
...
class registerType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='registerType', fromsubclass_=False, pretty_print=True):
        ...
        if self.dim is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdim>%s</%sdim>%s' % (namespace_, self.gds_format_string(quote_xml(self.dim).encode(ExternalEncoding), input_name='dim'), namespace_, eol_))
        if self.dimIncrement is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdimIncrement>%s</%sdimIncrement>%s' % (namespace_, self.gds_format_string(quote_xml(self.dimIncrement).encode(ExternalEncoding), input_name='dimIncrement'), namespace_, eol_))
        if self.dimIndex is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdimIndex>%s</%sdimIndex>%s' % (namespace_, self.gds_format_string(quote_xml(self.dimIndex).encode(ExternalEncoding), input_name='dimIndex'), namespace_, eol_))
        if self.name is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sname>%s</%sname>%s' % (namespace_, self.gds_format_string(quote_xml(self.name).encode(ExternalEncoding), input_name='name'), namespace_, eol_))
        ...
        if self.alternateGroup is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%salternateGroup>%s</%salternateGroup>%s' % (namespace_, self.gds_format_string(quote_xml(self.alternateGroup).encode(ExternalEncoding), input_name='alternateGroup'), namespace_, eol_))
        if self.addressOffset is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%saddressOffset>%s</%saddressOffset>%s' % (namespace_, self.gds_format_string(quote_xml(self.addressOffset).encode(ExternalEncoding), input_name='addressOffset'), namespace_, eol_))
        if self.size is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssize>%s</%ssize>%s' % (namespace_, self.gds_format_string(quote_xml(self.size).encode(ExternalEncoding), input_name='size'), namespace_, eol_))
        if self.access is not None:
        ...
        if self.modifiedWriteValues is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smodifiedWriteValues>%s</%smodifiedWriteValues>%s' % (namespace_, self.gds_format_string(quote_xml(self.modifiedWriteValues).encode(ExternalEncoding), input_name='modifiedWriteValues'), namespace_, eol_))
        ...
        if self.readAction is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sreadAction>%s</%sreadAction>%s' % (namespace_, self.gds_format_string(quote_xml(self.readAction).encode(ExternalEncoding), input_name='readAction'), namespace_, eol_))
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.dim is not None:
            showIndent(outfile, level)
            outfile.write('dim=%s,\n' % quote_python(self.dim).encode(ExternalEncoding))
        if self.dimIncrement is not None:
            showIndent(outfile, level)
            outfile.write('dimIncrement=%s,\n' % quote_python(self.dimIncrement).encode(ExternalEncoding))
        if self.dimIndex is not None:
            showIndent(outfile, level)
            outfile.write('dimIndex=%s,\n' % quote_python(self.dimIndex).encode(ExternalEncoding))
        if self.name is not None:
            showIndent(outfile, level)
            outfile.write('name=%s,\n' % quote_python(self.name).encode(ExternalEncoding))
        if self.displayName is not None:
        ...
        if self.alternateGroup is not None:
            showIndent(outfile, level)
            outfile.write('alternateGroup=%s,\n' % quote_python(self.alternateGroup).encode(ExternalEncoding))
        if self.addressOffset is not None:
            showIndent(outfile, level)
            outfile.write('addressOffset=%s,\n' % quote_python(self.addressOffset).encode(ExternalEncoding))
        if self.size is not None:
            showIndent(outfile, level)
            outfile.write('size=%s,\n' % quote_python(self.size).encode(ExternalEncoding))
        if self.access is not None:
        ...
        if self.modifiedWriteValues is not None:
            showIndent(outfile, level)
            outfile.write('modifiedWriteValues=%s,\n' % quote_python(self.modifiedWriteValues).encode(ExternalEncoding))
        if self.writeConstraint is not None:
            showIndent(outfile, level)
        ...
        if self.readAction is not None:
            showIndent(outfile, level)
            outfile.write('readAction=%s,\n' % quote_python(self.readAction).encode(ExternalEncoding))
        if self.fields is not None:
            showIndent(outfile, level)
...
class fieldType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='fieldType', fromsubclass_=False, pretty_print=True):
        ...
        if self.lsb is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%slsb>%s</%slsb>%s' % (namespace_, self.gds_format_string(quote_xml(self.lsb).encode(ExternalEncoding), input_name='lsb'), namespace_, eol_))
        if self.msb is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smsb>%s</%smsb>%s' % (namespace_, self.gds_format_string(quote_xml(self.msb).encode(ExternalEncoding), input_name='msb'), namespace_, eol_))
        if self.bitOffset is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sbitOffset>%s</%sbitOffset>%s' % (namespace_, self.gds_format_string(quote_xml(self.bitOffset).encode(ExternalEncoding), input_name='bitOffset'), namespace_, eol_))
        if self.bitWidth is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sbitWidth>%s</%sbitWidth>%s' % (namespace_, self.gds_format_string(quote_xml(self.bitWidth).encode(ExternalEncoding), input_name='bitWidth'), namespace_, eol_))
        if self.bitRange is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sbitRange>%s</%sbitRange>%s' % (namespace_, self.gds_format_string(quote_xml(self.bitRange).encode(ExternalEncoding), input_name='bitRange'), namespace_, eol_))
        if self.access is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%saccess>%s</%saccess>%s' % (namespace_, self.gds_format_string(quote_xml(self.access).encode(ExternalEncoding), input_name='access'), namespace_, eol_))
        if self.modifiedWriteValues is not None:
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.lsb is not None:
            showIndent(outfile, level)
            outfile.write('lsb=%s,\n' % quote_python(self.lsb).encode(ExternalEncoding))
        if self.msb is not None:
            showIndent(outfile, level)
            outfile.write('msb=%s,\n' % quote_python(self.msb).encode(ExternalEncoding))
        if self.bitOffset is not None:
            showIndent(outfile, level)
            outfile.write('bitOffset=%s,\n' % quote_python(self.bitOffset).encode(ExternalEncoding))
        if self.bitWidth is not None:
            showIndent(outfile, level)
            outfile.write('bitWidth=%s,\n' % quote_python(self.bitWidth).encode(ExternalEncoding))
        if self.bitRange is not None:
            showIndent(outfile, level)
            outfile.write('bitRange=%s,\n' % quote_python(self.bitRange).encode(ExternalEncoding))
        if self.access is not None:
            showIndent(outfile, level)
            outfile.write('access=%s,\n' % quote_python(self.access).encode(ExternalEncoding))
        if self.modifiedWriteValues is not None:
