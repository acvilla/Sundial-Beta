...
#
# Generated Tue Sep 23 13:53:26 2014 by generateDS.py version 2.12d.
#
# Command line options:
#   ('-o', '..\\pyrmsvd\\base\\Bindings.py')
#   ('--super', 'Bindings')
#   ('-s', '..\\pyrmsvd\\base\\Template.py')
#   ('--subclass-suffix', '')
#   ('-m', '')
#   ('-f', '')
#   ('--silence', '')
...
#
# Command line:
#   T:\python_2_7_7_win32_rel_2_7_7_1\Scripts\generateDS.py -o "..\pyrmsvd\base\Bindings.py" --super="Bindings" -s "..\pyrmsvd\base\Template.py" --subclass-suffix -m -f --silence .\CMSIS-SVD_Schema_1_0.xsd
#
