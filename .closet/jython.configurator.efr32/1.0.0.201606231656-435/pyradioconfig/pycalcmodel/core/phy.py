...
from profile import ModelProfile, ModelProfileContainer
from variable import ModelVariableContainer
from input import ModelInputValueContainer, ModelInputValue
from output import ModelOutputOverrideContainer, ModelOutputOverride
from parser import *
import sys
...
class ModelPhy(object):
    ...
    def __init__(self, name, desc, profile, group_name, readable_name=None, act_logic=''):
        self.name = name
    ...
    def to_type_xml(self):
        return model_type.phyType(name=self.name,
                                  ...
                                  profile_inputs=self.profile_inputs.to_type_xml(),
