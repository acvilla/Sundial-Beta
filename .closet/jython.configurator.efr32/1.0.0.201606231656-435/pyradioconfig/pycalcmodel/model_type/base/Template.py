...
#
# Command line:
#   T:\python_2_7_7_win32_rel_5\Scripts\generateDS.py -o "..\..\model_type\base\Bindings.py" --super="Bindings" -s "..\..\model_type\base\Template.py" --subclass-suffix -m -f --silence .\model_type.xsd
#
...
class inputType1(supermod.inputType1):
    def __init__(self, value_limit_max=None, input_type=None, is_array=None, default_visiblity=None, deprecated=None, value_limit_min=None, fractional_digits=None, readable_name=None, category=None, var_name=None, defaults=None):
        super(inputType1, self).__init__(value_limit_max, input_type, is_array, default_visiblity, deprecated, value_limit_min, fractional_digits, readable_name, category, var_name, defaults, )
