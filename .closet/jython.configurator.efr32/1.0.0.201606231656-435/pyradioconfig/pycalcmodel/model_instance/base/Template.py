...
#
# Generated Mon Mar 21 12:04:20 2016 by generateDS.py version 2.12d.
#
...
#
# Command line:
#   T:\python_2_7_7_win32_rel_5\Scripts\generateDS.py -o "..\..\model_instance\base\Bindings.py" --super="Bindings" -s "..\..\model_instance\base\Template.py" --subclass-suffix -m -f --silence .\model_instance.xsd
#
...
class phyType(supermod.phyType):
    def __init__(self, name=None, readable_name=None, group_name=None, profile_name=None, act_logic=None, desc=None, profile_inputs=None, profile_outputs=None):
        super(phyType, self).__init__(name, readable_name, group_name, profile_name, act_logic, desc, profile_inputs, profile_outputs, )
...
class inputType1(supermod.inputType1):
    def __init__(self, value_limit_max=None, input_type=None, is_array=None, default_visiblity=None, deprecated=None, value_limit_min=None, fractional_digits=None, readable_name=None, category=None, var_name=None, var_values=None, defaults=None):
        super(inputType1, self).__init__(value_limit_max, input_type, is_array, default_visiblity, deprecated, value_limit_min, fractional_digits, readable_name, category, var_name, var_values, defaults, )
