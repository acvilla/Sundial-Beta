...
class model(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='model'):
        if self.part_family is not None and 'part_family' not in already_processed:
            ...
            outfile.write(' part_family=%s' % (self.gds_format_string(quote_attrib(self.part_family).encode(ExternalEncoding), input_name='part_family'), ))
        ...
        if self.error_message is not None and 'error_message' not in already_processed:
            ...
            outfile.write(' error_message=%s' % (self.gds_format_string(quote_attrib(self.error_message).encode(ExternalEncoding), input_name='error_message'), ))
        if self.part_revision is not None and 'part_revision' not in already_processed:
            already_processed.add('part_revision')
            outfile.write(' part_revision=%s' % (self.gds_format_string(quote_attrib(self.part_revision).encode(ExternalEncoding), input_name='part_revision'), ))
        if self.calc_version is not None and 'calc_version' not in already_processed:
            already_processed.add('calc_version')
            outfile.write(' calc_version=%s' % (self.gds_format_string(quote_attrib(self.calc_version).encode(ExternalEncoding), input_name='calc_version'), ))
        ...
        if self.xsd_version is not None and 'xsd_version' not in already_processed:
            ...
            outfile.write(' xsd_version=%s' % (self.gds_format_string(quote_attrib(self.xsd_version).encode(ExternalEncoding), input_name='xsd_version'), ))
...
class phyType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='phyType'):
        ...
        if self.readable_name is not None and 'readable_name' not in already_processed:
            ...
            outfile.write(' readable_name=%s' % (self.gds_format_string(quote_attrib(self.readable_name).encode(ExternalEncoding), input_name='readable_name'), ))
        ...
        if self.act_logic is not None and 'act_logic' not in already_processed:
            ...
            outfile.write(' act_logic=%s' % (self.gds_format_string(quote_attrib(self.act_logic).encode(ExternalEncoding), input_name='act_logic'), ))
        if self.desc is not None and 'desc' not in already_processed:
            already_processed.add('desc')
            outfile.write(' desc=%s' % (self.gds_format_string(quote_attrib(self.desc).encode(ExternalEncoding), input_name='desc'), ))
...
class profile_inputType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='profile_inputType', fromsubclass_=False, pretty_print=True):
        ...
        if self.readable_name is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sreadable_name>%s</%sreadable_name>%s' % (namespace_, self.gds_format_string(quote_xml(self.readable_name).encode(ExternalEncoding), input_name='readable_name'), namespace_, eol_))
        if self.var_name is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%svar_name>%s</%svar_name>%s' % (namespace_, self.gds_format_string(quote_xml(self.var_name).encode(ExternalEncoding), input_name='var_name'), namespace_, eol_))
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.readable_name is not None:
            showIndent(outfile, level)
            outfile.write('readable_name=%s,\n' % quote_python(self.readable_name).encode(ExternalEncoding))
        if self.var_name is not None:
            showIndent(outfile, level)
            outfile.write('var_name=%s,\n' % quote_python(self.var_name).encode(ExternalEncoding))
        if self.category is not None:
            showIndent(outfile, level)
...
class inputType1(GeneratedsSuper):
    ...
    visibility applicable to a GUI"""
    subclass = None
    superclass = None
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='inputType1'):
        if self.value_limit_max is not None and 'value_limit_max' not in already_processed:
            ...
            outfile.write(' value_limit_max=%s' % (self.gds_format_string(quote_attrib(self.value_limit_max).encode(ExternalEncoding), input_name='value_limit_max'), ))
        ...
        if self.value_limit_min is not None and 'value_limit_min' not in already_processed:
            ...
            outfile.write(' value_limit_min=%s' % (self.gds_format_string(quote_attrib(self.value_limit_min).encode(ExternalEncoding), input_name='value_limit_min'), ))
