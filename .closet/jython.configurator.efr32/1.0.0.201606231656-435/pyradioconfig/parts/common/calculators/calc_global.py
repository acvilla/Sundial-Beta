...
class CALC_Global(ICalculator):
    ...
    def buildVariables(self, model):
        ...
        self._addModelVariable(model,    'frequency_offset_period',int,   ModelVariableFormat.DECIMAL,               desc='Period used to estimate frequency offset')
        ...
        self._addModelVariable(model,   'syncword_0_left',           long,   ModelVariableFormat.HEX,                   desc="Default sync word. Left aligned to the first 4-bit boundary. First bit in MSB.")
        self._addModelVariable(model,   'syncword_1_left',           long,   ModelVariableFormat.HEX,                   desc="Alternative sync word for dual sync word cases.  Left aligned to the first 4-bit boundary. First bit in MSB")
        self._addModelVariable(model,   'preamble_pattern_left',      int,   ModelVariableFormat.DECIMAL,               desc='Minimum repeated portion of the preamble such as binary 01 or 10. ')
        ...
        var = self._addModelVariable(model, 'frequency_comp_mode', Enum, ModelVariableFormat.DECIMAL, desc='')
        member_data = [
        ...
        self._addModelActual(model,    'rx_synth_freq'         ,  int,    ModelVariableFormat.DECIMAL	)
