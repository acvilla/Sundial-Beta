...
class CALC_CRC(ICalculator):
    ...
    def _calc_init(self, model):
        ...
        self._reg_write(model.vars.CRC_INIT_INIT, 0L)
        self._reg_write(model.vars.CRC_POLY_POLY, 0L)
    ...
    def calc_crc_settings(self, model):
        ...
        CRC_POLY_LOOKUP = {
            model.vars.crc_poly.var_enum.NONE.value:          (           0L, 0 ),
            model.vars.crc_poly.var_enum.CRC_8.value:         (       0x107L, 1 ),
            model.vars.crc_poly.var_enum.CRC_16.value:        (     0x18005L, 2 ),
            model.vars.crc_poly.var_enum.CCITT_16.value:      (     0x11021L, 2 ),
            model.vars.crc_poly.var_enum.DNP_16.value:        (     0x13d65L, 2 ),
            model.vars.crc_poly.var_enum.BLE_24.value:        (   0x100065bL, 3 ),
            model.vars.crc_poly.var_enum.CRC_32Q.value:       ( 0x1814141abL, 4 ),
            model.vars.crc_poly.var_enum.ANSIX366_1979.value: ( 0x104c11db7L, 4 ),
        }
