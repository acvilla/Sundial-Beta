...
class CALC_Freq_Offset_Comp(ICalculator):
    ...
    def calc_freq_comp_mode(self, model):
        ...
        elif preamble_len >= 40 and bitrate > bitrate_limit:
    ...
    def calc_compmode_reg(self, model):
        ...
        if mode_index == 1:
            ...
            print "ERROR: frequency_comp_mode not recognized!"
    ...
    def calc_offsub_reg(self, model):
        ...
        for den in xrange(1, 16):
            for num in xrange(1, 16):
                ...
                error = abs(closest_power_of_two - timing_samples * num / den)
        ...
        #FIXME: why do I get num and den interchanged?
        self._reg_write(model.vars.MODEM_TIMING_OFFSUBDEN, best_num)
        self._reg_write(model.vars.MODEM_TIMING_OFFSUBNUM, best_den)
    ...
    def calc_afcavgper_reg(self, model):
        ...
        self._reg_write(model.vars.MODEM_AFC_AFCAVGPER, afcavgper)
    ...
    def calc_freqoffestlim_reg(self, model):
        ...
        if modulation == model.vars.modulation_type.var_enum.OOK or \
           modulation == model.vars.modulation_type.var_enum.ASK:
            reg = 2   # empirically determined to work well
