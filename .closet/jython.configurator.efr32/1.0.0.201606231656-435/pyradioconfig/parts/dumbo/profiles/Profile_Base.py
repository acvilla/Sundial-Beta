...
class Profile_Base(IProfile):
    ...
    def buildProfileModel(self, model):
        ...
        profile.inputs.append(ModelInput(model.vars.syncword_0,             "syncword", input_type=ModelInputType.REQUIRED, readable_name="Sync Word 0",                value_limit_min=0L,        value_limit_max=0xffffffffL))
...
#        profile.inputs.append(ModelInput(model.vars.preamble_pattern_left,  "preamble", input_type=ModelInputType.REQUIRED, readable_name="Preamble Base Pattern",      value_limit_min=0,         value_limit_max=15))
        ...
        profile.outputs.append(ModelOutput(model.vars.bandwidth_actual                  , '', ModelOutputType.INFO, readable_name='Calculated Actual Bandwidth'))
        ...
        #profile.outputs.append(ModelOutput(model.vars.IR_CAL_StandardSet           , '', ModelOutputType.CONFIG_FUNCTION, readable_name='IR CAL Standard Set'             ))
