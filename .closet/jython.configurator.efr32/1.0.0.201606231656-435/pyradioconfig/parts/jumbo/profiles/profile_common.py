...
def buildWhiteIO(model, profile):
    #Inputs
    profile.inputs.append(ModelInput(model.vars.white_poly, 'white', ModelInputType.REQUIRED, default=model.vars.white_poly.var_enum.NONE, readable_name="Whitening Polynomial"))
    profile.inputs.append(ModelInput(model.vars.white_seed, 'white', ModelInputType.OPTIONAL, default=0x00000000, readable_name="Whitening Seed", value_limit_min=0, value_limit_max=0xFFFF))
    profile.inputs.append(ModelInput(model.vars.white_output_bit, 'white', ModelInputType.OPTIONAL, default=0, readable_name="Whitening Output Bit", value_limit_min=0, value_limit_max=0x0F))

    #Output
    profile.outputs.append(eval(_buildModelOutputStringFromRegisterField('FRC_WHITECTRL_SHROUTPUTSEL', 'white')))
    profile.outputs.append(eval(_buildModelOutputStringFromRegisterField('FRC_WHITECTRL_XORFEEDBACK', 'white')))
    profile.outputs.append(eval(_buildModelOutputStringFromRegisterField('FRC_WHITECTRL_FEEDBACKSEL', 'white')))
    profile.outputs.append(eval(_buildModelOutputStringFromRegisterField('FRC_WHITEPOLY_POLY', 'white')))
    profile.outputs.append(eval(_buildModelOutputStringFromRegisterField('FRC_WHITEINIT_WHITEINIT', 'white')))
...
def buildFecIO(model, profile):
    #Inputs
    profile.inputs.append(ModelInput(model.vars.fec_en, 'fec', ModelInputType.OPTIONAL, default=model.vars.fec_en.var_enum.NONE, readable_name="FEC Algorithm"))
