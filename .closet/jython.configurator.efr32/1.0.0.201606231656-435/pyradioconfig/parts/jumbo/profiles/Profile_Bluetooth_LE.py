...
from pyradioconfig.parts.jumbo.profiles.Profile_Base import Profile_Base
...
class Profile_Bluetooth_LE(Profile_Base):
    ...
    def buildProfileModel(self, model):
        ...
        profile.forces.frequency_comp_mode.value = model.vars.frequency_comp_mode.var_enum.INTERNAL_ALWAYS_ON
        ...
        profile.forces.crc_bit_endian.value = model.vars.crc_bit_endian.var_enum.LSB_FIRST
